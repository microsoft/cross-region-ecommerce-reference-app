...
@description('The target number of user node pool nodes.')
...
@description('Specifies the availability zones for the Azure Kubernetes Service (AKS) cluster. This parameter determines the zones in which the AKS nodes will be deployed to ensure high availability.')
...
resource aks 'Microsoft.ContainerService/managedClusters@2024-02-01' = {
  ...
  properties: {
    ...
    // https://eng.ms/docs/microsoft-security/cloud-ecosystem-security/azure-security/security-health-analytics/sha-intelligence/threat-vulnerability-management/remediate/vmss#vmss-aks---aks-automatic-os-upgrades
    autoUpgradeProfile: {
